...
import 'package:prime_ai_flutter_ui_kit/localization/ru_ru.dart';
import 'package:prime_ai_flutter_ui_kit/localization/zh_cn.dart';

abstract class AppTranslation {
  static Map<String, Map<String, String>> translationsKeys = {"en": enUS, "hi": hiIN, "ar": arSA, "de": deDE, "fr": frFR, "zh": zhCN, "ru": ruRU};
}
