...
class HistoryChatView extends StatefulWidget {
  const HistoryChatView({Key? key}) : super(key: key);
...
class _HistoryChatViewState extends State<HistoryChatView> {
  ...
  Widget build(BuildContext context) {
    ...
    final appBarText = args['appBarText'] ?? StringConfig.historyChat;
    return Scaffold(
          ...
          children: [
            Expanded(
              child: ListView(
                ...
                children: buildUpdatedChatContent()
              ),
            ),
          ],
        ),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          Clipboard.setData(const ClipboardData(text: StringConfig.iAIPreviewMessage));
