...
class MoreTranslateLanguageChatView extends StatefulWidget {
  const MoreTranslateLanguageChatView({Key? key}) : super(key: key);

  @override
  State<MoreTranslateLanguageChatView> createState() => _MoreTranslateLanguageChatViewState();
}

class _MoreTranslateLanguageChatViewState extends State<MoreTranslateLanguageChatView> {
  ...
  Widget build(BuildContext context) {
    double containerWidth = chatController.isUpdated ? SizeConfig.width125 : SizeConfig.width144;
    String buttonText = chatController.isUpdated ? StringConfig.stopGenerating : StringConfig.regenerateResponse;
    AssetImage image = chatController.isUpdated ? const AssetImage(ImageConfig.responseGet) : const AssetImage(ImageConfig.refreshResponse);
    return Scaffold(
      backgroundColor: ColorConfig.backgroundWhiteColor,
      appBar: CommonAppBar(
        backgroundColor: ColorConfig.backgroundWhiteColor,
        centerTitle: true,
        title: StringConfig.translateLanguageInline,
        leading: Center(
          child: Padding(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            Expanded(
              child: ListView(
                physics: chatController.isSendButtonPressed ? chatController.listViewPhysics : const NeverScrollableScrollPhysics(),
                ...
                Column(
                  children: [
                    Visibility(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only(top: SizeConfig.padding10, bottom: SizeConfig.padding10),
                        child: GestureDetector(
                          onTap: () {
                            toggleTextAndImage();
                          },
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: Padding(
                            padding: const EdgeInsets.only(top: SizeConfig.padding05),
                            child: TextFormField(
                              controller: chatController.askController,
                              cursorColor: ColorConfig.primaryColor,
                              focusNode: chatController.focusNode,
                              onChanged: (text) {
                                chatController.isTextEntered.value = text.isNotEmpty;
                              },
                              style: TextStyle(
                                fontFamily: FontFamilyConfig.outfitRegular,
                                fontSize: FontSizeConfig.body1Text,
                                fontWeight: FontWeight.w400,
                                color: chatController.isFocused ? ColorConfig.primaryColor : ColorConfig.textColor,
                              ),
                              decoration: InputDecoration(
                                ...
                                isDense: true,
                                filled: true,
                                fillColor: chatController.isFocused ? ColorConfig.backgroundLightColor : ColorConfig.backgroundColor,
                          ...
                          builder: (context, textEntered, child) {
                            return textEntered
                              ...
                              child: const Image(
                                ...
                                : const Image(
                              image: AssetImage(ImageConfig.voiceAssistant),
                              width: SizeConfig.width42,
                            );
                          },
                        ),
          ...
          child: Column(
            children: [
              Image(
                ...
                color: ColorConfig.secondaryColor.withOpacity(SizeConfig.opacityPoint06),
              ),
              const SizedBox(
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  fontSize: FontSizeConfig.heading4Text,
                  fontWeight: FontWeight.w400,
                  color: ColorConfig.textMediumColor.withOpacity(SizeConfig.opacityPoint06),
                ),
              ),
              const Divider(
                color: ColorConfig.dividerColor,
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  fontSize: FontSizeConfig.body1Text,
                  fontWeight: FontWeight.w400,
                  color: ColorConfig.textMediumColor.withOpacity(SizeConfig.opacityPoint05),
                ),
              ),
              const SizedBox(
      ...
      const Column(
        ...
        children: [
          MessageContainer(
            ...
            height: SizeConfig.height82,
            isRight: true,
            text: StringConfig.translateSentence,
          ),
          MessageContainer(
            width: SizeConfig.width255,
            height: SizeConfig.height68,
            isRight: false,
            text: StringConfig.translatedLanguage,
          ),
          MessageContainer(
            width: SizeConfig.width255,
            height: SizeConfig.height82,
            isRight: true,
            text: StringConfig.translateSentence2,
          ),
          MessageContainer(
            width: SizeConfig.width255,
            height: SizeConfig.height86,
            isRight: false,
            text: StringConfig.translatedLanguage2,
          ),
        ],
      )
    ];
...
class MessageContainer extends StatelessWidget {
  ...
  const MessageContainer({required this.isRight, required this.text, required this.width, required this.height});
    ...
    return Row(
      ...
      children: [
        Container(
          width: width,
          height: height,
          padding: const EdgeInsets.only(left: SizeConfig.padding20, right: SizeConfig.padding15),
          margin: const EdgeInsets.symmetric(vertical: SizeConfig.margin07),
          decoration: BoxDecoration(
            color: isRight ? ColorConfig.primaryColor : ColorConfig.backgroundColor,
          ...
          child: Column(
            ...
            children: [
              Align(
                alignment: isRight ? Alignment.centerLeft : Alignment.centerLeft,
                child: Text(
                  text,
                  style: TextStyle(
                    fontFamily: FontFamilyConfig.outfitRegular,
                    fontWeight: FontWeight.w400,
                    fontSize: FontSizeConfig.body1Text,
                    color: isRight ? ColorConfig.textWhiteColor : ColorConfig.textColor,
                  ),
                ),
              ),
              if (!isRight)
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          Clipboard.setData(const ClipboardData(text: StringConfig.articlesForGoogleDescribeChat));
...
class _CustomDislikeDialogState extends State<CustomDislikeDialog> {
  ...
  @override
  Widget build(BuildContext context) {
    AssetImage image1 = controller.isUpdatedImage1 ? const AssetImage(ImageConfig.checkFeedback) : const AssetImage(ImageConfig.checkBoxSquare);
    AssetImage image2 = controller.isUpdatedImage2 ? const AssetImage(ImageConfig.checkFeedback) : const AssetImage(ImageConfig.checkBoxSquare);
    AssetImage image3 = controller.isUpdatedImage3 ? const AssetImage(ImageConfig.checkFeedback) : const AssetImage(ImageConfig.checkBoxSquare);
    return Material(
      type: MaterialType.transparency,
      child: Padding(
        padding: const EdgeInsets.only(left: SizeConfig.padding20, right: SizeConfig.padding20, bottom: SizeConfig.padding20, top: SizeConfig.padding20),
