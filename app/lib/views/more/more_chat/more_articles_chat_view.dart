...
class MoreArticlesChatView extends StatefulWidget {
  const MoreArticlesChatView({Key? key}) : super(key: key);

  @override
  State<MoreArticlesChatView> createState() => _MoreArticlesChatViewState();
}

class _MoreArticlesChatViewState extends State<MoreArticlesChatView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CommonAppBar(
        ...
        actions: [
          Padding(
            padding: const EdgeInsets.only(right: SizeConfig.padding20),
            child: GestureDetector(
              onTap: () async {
      ...
      const Column(
        ...
        children: [
          MessageContainer(
            ...
            isRight: true,
            text: StringConfig.articlesForGoogle,
          ),
          MessageContainer(
            width: SizeConfig.width255,
            height:SizeConfig.height560,
            isRight: false,
            text: StringConfig.articlesForGoogleDescribeChat,
          ),
        ],
      )
    ];
