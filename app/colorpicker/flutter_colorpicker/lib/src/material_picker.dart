        ...
        child: ListView(
          ...
          children: [
            ...
            ..._shadingTypes(_currentColorType).map((Map<Color, String> color) {
              final Color colors = color.keys.first;
              return GestureDetector(
                onTap: () {
                  setState(() => _currentShading = colors);
                ...
                child: Container(
                  ...
                  child: Align(
                    child: AnimatedContainer(
                      ...
                      width: isPortrait
                          ? (_currentShading == colors ? 250 : 230)
                          : (_currentShading == colors ? 50 : 30),
                      height: isPortrait ? 50 : 220,
                      decoration: BoxDecoration(
                        color: colors,
                        boxShadow: _currentShading == colors
                            ? [
                                (colors == Colors.white) ||
                                        (colors == Colors.black)
                                    ? BoxShadow(
                      ...
                      child: widget.enableLabel
                          ? isPortrait
                              ? Row(
                                  children: [
                                    Text(
                                      '  ${color.values.first}',
                                      style: TextStyle(
                                          color: useWhiteForeground(colors)
                                              ? Colors.white
                                              : Colors.black),
                                    ),
                                    Expanded(
                                      child: Align(
                                        ...
                                        child: Text(
                                          '#${(colors.toString().replaceFirst('Color(0xff', '').replaceFirst(')', '')).toUpperCase()}  ',
                                          style: TextStyle(
                                            color: useWhiteForeground(colors)
                                                ? Colors.white
                                                : Colors.black,
                              ...
                              : AnimatedOpacity(
                                  duration: const Duration(milliseconds: 300),
                                  opacity: _currentShading == colors ? 1 : 0,
                                  child: Container(
