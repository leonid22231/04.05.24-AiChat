...
import com.thedeveloper.aichat.utils.storage.StorageException;
import com.thedeveloper.aichat.utils.storage.StorageFileNotFoundException;
...
@Service
@Slf4j
public class UserPhotoService implements StorageService {
    private final Path rootLocation;

    public UserPhotoService(UserProfilePhotoProperties properties) {
